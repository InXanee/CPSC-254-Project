...
void Minion::points(int iPoints) {
	...
	//ISMAEL SHIT
	CCore::getMap()->getPlayer()->setKillcounter(CCore::getMap()->getPlayer()->getKillCounter() + 1);
	//addKill();
...
//unsigned int Minion::getKillCounter(){
//	return killCountNum;
//}

//void Minion::setKillcounter(unsigned int killCountNum){
//	this->killCountNum = killCountNum;
//}
