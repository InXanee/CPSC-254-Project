...
void Map::DrawGameLayout(SDL_Renderer* rR) {
	CCFG::getText()->Draw(rR, "LUIGI", 54, 16);
	...
	/************************************/
	//ISMAEL SHIT
	CCFG::getText()->Draw(rR,"KILLCOUNT:", 195, 16);
	if(oPlayer->getKillCounter() < 10) {
		CCFG::getText()->Draw(rR, "00" + std::to_string(oPlayer->getKillCounter()), 350, 16);
	} else if(oPlayer->getScore() < 100) {
		CCFG::getText()->Draw(rR, "0" + std::to_string(oPlayer->getKillCounter()), 350, 16);
	}else {
		CCFG::getText()->Draw(rR, std::to_string(oPlayer->getKillCounter()), 350, 16);
	}
//////////////////////////////////////
...
void Map::loadMinionsLVL_1_1() {
	...
	//Ismael
	addSpikey(625, 50);
	addGoombas(650, 100, true);
	addHammerBro(650, 50);
	addGoombas(750, 200, false);
	addGoombas(800, 50, false);
	addHammerBro(850, 50);
	addGoombas(900, 50, false);
...
////////////Ismael
	...
	addKoppa(100*32, 100, 1, false);
	addKoppa(96*32, 100, 1, true);
...
///////Ismael
	...
	addGoombas(3800, 50, false);
	addSpikey(3700, 50);
	addSpikey(3750, 50);

	addGoombas(4050, 50, true);

	addGoombas(4096, 368, true);
	addGoombas(4016, 368, false);

	addGoombas(4144, 50, true);
	addHammerBro(4244, 50);

	addGoombas(4800, 50, true);

	addGoombas(5568, 368, true);
	addHammerBro(5600, 50);
	addHammerBro(5550, 50);
...
void Map::loadMinionsLVL_1_2() {
	...
	//Ismael
	addHammerBro(15*32, 250);
	addHammerBro(19*32, 250);
	addHammerBro(23*32, 250);
...
////////////////////////
	...
	//Ismael
	addHammerBro(65*32, 250);
	addHammerBro(64*32, 250);
	//////////////////////////////

	addGoombas(63*32, 368, true);
...
void Map::loadMinionsLVL_1_3() {
	...
	//Ismael
	addHammerBro(28*32,  CCFG::GAME_HEIGHT - 16 - 15*32);
	addHammerBro(28*32,  CCFG::GAME_HEIGHT - 16 - 15*32);
//////////////////////////
	...
	//Ismael
	addHammerBro(44*32, CCFG::GAME_HEIGHT - 16 - 16*32);
	addHammerBro(44*32, CCFG::GAME_HEIGHT - 16 - 16*32);


	addGoombas(46*32, CCFG::GAME_HEIGHT - 16 - 11*32, true);
	addGoombas(80*32, CCFG::GAME_HEIGHT - 16 - 9*32, true);
	addGoombas(85*32, CCFG::GAME_HEIGHT - 16 - 9*32, true);
	addGoombas(84*32, CCFG::GAME_HEIGHT - 16 - 9*32, true);
	addGoombas(83*32, CCFG::GAME_HEIGHT - 16 - 9*32, false);
//////////////////////////////////////
...
void Map::loadMinionsLVL_1_4() {
	...
	//Ismael
	addHammerBro(100*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addHammerBro(110*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addHammerBro(115*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addSpikey(114*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addSpikey(113*32, CCFG::GAME_HEIGHT - 16 - 8*32);

///////////////////////////////////////

	addToad(153*32, CCFG::GAME_HEIGHT - 3*32, false);
//Ismael
	addHammerBro(18*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addSpikey(17*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	addSpikey(16*32, CCFG::GAME_HEIGHT - 16 - 8*32);
	...
	addHammerBro(65*32, CCFG::GAME_HEIGHT - 16 - 8*32);
