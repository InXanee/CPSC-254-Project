...
MainMenu::MainMenu(void) {
	...
	this->lMO.push_back(new MenuOption("1 PLAYER HARD MODE", 178, 308));
	...
	this->lMO.push_back(new MenuOption("HIGHSCORE", 200, 400));
...
void MainMenu::Draw(SDL_Renderer* rR) {
	...
	Menu::Draw(rR);
	//ISMAEL
	CCFG::getText()->Draw(rR, "CPSC-254-Project", 4, CCFG::GAME_HEIGHT - 4 - 8, 8, 0, 0, 0);
	CCFG::getText()->Draw(rR, "CPSC-254-Project", 5, CCFG::GAME_HEIGHT - 5 - 8, 8, 255, 255, 255);
////////////////////
	if(selectWorld) {
